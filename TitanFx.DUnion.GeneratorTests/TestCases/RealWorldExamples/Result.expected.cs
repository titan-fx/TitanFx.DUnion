...
/* Sources: 1 */
/* File Path: TitanFx.DUnion\TitanFx.DUnion.SourceGenerator\TestCases.Result[TOk, TErr].g.cs */
// =============================================================
...
namespace TestCases
{
    ...
    public readonly partial record struct Result<TOk, TErr> : System.IEquatable<TestCases.Result<TOk, TErr>>
    {
        ...
        (
            ...
            System.Action<TSwitchContext, TestCases.Result.Ok<TOk>>? caseOk = null,
            System.Action<TSwitchContext, TestCases.Result.Err<TErr>>? caseErr = null
        )
        {
            switch(this._discriminator)
            {
                ...
                case 1:
                    ...
                    {
                        caseOk.Invoke(context, ((TestCases.Result.Ok<TOk>)this._value));
                    }
                ...
                case 2:
                    ...
                    {
                        caseErr.Invoke(context, ((TestCases.Result.Err<TErr>)this._value));
                    }
                    else if (!System.Object.ReferenceEquals(@default, null))
                    {
                        @default.Invoke(context);
        ...
        (
            TSwitchContext context,
            System.Action<TSwitchContext,TestCases.Result.Ok<TOk>>? caseOk,
            System.Action<TSwitchContext,TestCases.Result.Err<TErr>>? caseErr
        )
        {
            switch(this._discriminator)
            {
        ...
        (
            ...
            System.Func<TMatchContext, TestCases.Result.Ok<TOk>, TMatchResult>? caseOk = null,
            System.Func<TMatchContext, TestCases.Result.Err<TErr>, TMatchResult>? caseErr = null
        )
        {
            switch(this._discriminator)
            {
                ...
                case 1:
                    if (!System.Object.ReferenceEquals(caseOk, null))
                    {
                        return caseOk.Invoke(context, ((TestCases.Result.Ok<TOk>)this._value));
                    }
                    else if (!System.Object.ReferenceEquals(@default, null))
                    {
                ...
                case 2:
                    if (!System.Object.ReferenceEquals(caseErr, null))
                    {
                        return caseErr.Invoke(context, ((TestCases.Result.Err<TErr>)this._value));
                    }
                    else if (!System.Object.ReferenceEquals(@default, null))
                    {
                        return @default.Invoke(context);
        ...
        (
            TMatchContext context,
            System.Func<TMatchContext, TestCases.Result.Ok<TOk>, TMatchResult> caseOk,
            System.Func<TMatchContext, TestCases.Result.Err<TErr>, TMatchResult> caseErr
        )
        {
            switch(this._discriminator)
            {
        ...
        sealed class DebuggerTypeProxy<TOk, TErr>
        {
            private readonly TestCases.Result<TOk, TErr> _value;
    
            DebuggerTypeProxy(TestCases.Result<TOk, TErr> value)
            {
                _value = value;
            }
            ...
            public System.Type Type 
            {
                get
                {
                    switch(_value._discriminator)
                    {
                        ...
                        case 1:
                            return typeof(TestCases.Result.Ok<TOk>);
                        
                        case 2:
                            return typeof(TestCases.Result.Err<TErr>);
