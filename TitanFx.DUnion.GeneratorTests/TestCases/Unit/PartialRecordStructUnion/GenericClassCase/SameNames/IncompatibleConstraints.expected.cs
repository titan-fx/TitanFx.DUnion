/* Diagnostics: 1 */
/*
(11,24): error DYNUNION007: The type parameter 'T' on 'TestCases.Union.Case2`1' is not compatible with the type parameter 'T' on 'TestCases.Union.Case1`1'. These type parameters map onto the same type parameter on their enclosing union, and so must have identical constraints.
*/
/* Sources: 1 */
/* File Path: TitanFx.DUnion\TitanFx.DUnion.SourceGenerator\TestCases.Union[T].g.cs */
// =============================================================
...
namespace TestCases
{
        ...
        where T : struct
    {
        ...
        (
            ...
            System.Action<TSwitchContext, TestCases.Union.Case1<T>>? caseCase1 = null,
            System.Action<TSwitchContext, TestCases.Union.Case2<T>>? caseCase2 = null
        )
        {
            switch(this._discriminator)
            {
                ...
                case 1:
                    ...
                    {
                        caseCase1.Invoke(context, ((TestCases.Union.Case1<T>)this._value));
                    }
                ...
                case 2:
                    ...
                    {
                        caseCase2.Invoke(context, ((TestCases.Union.Case2<T>)this._value));
                    }
                    else if (!System.Object.ReferenceEquals(@default, null))
                    {
                        @default.Invoke(context);
        ...
        (
            TSwitchContext context,
            System.Action<TSwitchContext,TestCases.Union.Case1<T>>? caseCase1,
            System.Action<TSwitchContext,TestCases.Union.Case2<T>>? caseCase2
        )
        {
            switch(this._discriminator)
            {
        ...
        (
            ...
            System.Func<TMatchContext, TestCases.Union.Case1<T>, TMatchResult>? caseCase1 = null,
            System.Func<TMatchContext, TestCases.Union.Case2<T>, TMatchResult>? caseCase2 = null
        )
        {
            switch(this._discriminator)
            {
                ...
                case 1:
                    if (!System.Object.ReferenceEquals(caseCase1, null))
                    {
                        return caseCase1.Invoke(context, ((TestCases.Union.Case1<T>)this._value));
                    }
                    else if (!System.Object.ReferenceEquals(@default, null))
                    {
                ...
                case 2:
                    if (!System.Object.ReferenceEquals(caseCase2, null))
                    {
                        return caseCase2.Invoke(context, ((TestCases.Union.Case2<T>)this._value));
                    }
                    else if (!System.Object.ReferenceEquals(@default, null))
                    {
                        return @default.Invoke(context);
        ...
        (
            TMatchContext context,
            System.Func<TMatchContext, TestCases.Union.Case1<T>, TMatchResult> caseCase1,
            System.Func<TMatchContext, TestCases.Union.Case2<T>, TMatchResult> caseCase2
        )
        {
            switch(this._discriminator)
            {
        ...
        sealed class DebuggerTypeProxy<T>
        {
            private readonly TestCases.Union<T> _value;
    
            DebuggerTypeProxy(TestCases.Union<T> value)
            {
                _value = value;
            }
            ...
            public System.Type Type 
            {
                get
                {
                    switch(_value._discriminator)
                    {
                        ...
                        case 1:
                            return typeof(TestCases.Union.Case1<T>);
                        
                        case 2:
                            return typeof(TestCases.Union.Case2<T>);
