...
{
    private static readonly JsonValue[] _array = new JsonValue[]
    {
        new JsonValue.Number(123),
        new JsonValue.String("abc"),
    };
    private static readonly JsonValue[] _array2 = new JsonValue[]
    {
        new JsonValue.Number(456),
        new JsonValue.String("def"),
    };

    private static readonly IReadOnlyDictionary<string, JsonValue> _object = new Dictionary<
        string,
        JsonValue
    >
    {
    ...
    private static readonly IReadOnlyDictionary<string, JsonValue> _object2 = new Dictionary<
        string,
        JsonValue
    >
    {
    ...
    public static TheoryData<JsonValue, JsonValue.Array> AsArrayOrDefault_NoArgs_Data =>
        new()
        {
            { State(0), default },
    ...
    public static TheoryData<
        ...
        JsonValue.Array,
        JsonValue.Array
    > AsArrayOrDefault_WithArgs_Data =>
        new()
        {
    ...
    public static TheoryData<JsonValue, JsonValue.Boolean> AsBooleanOrDefault_NoArgs_Data =>
        new()
        {
            { State(0), default },
            { new JsonValue.Null(), default },
    ...
    public static TheoryData<
        ...
        JsonValue.Boolean,
        JsonValue.Boolean
    > AsBooleanOrDefault_WithArgs_Data =>
        new()
        {
            { State(0), default, default },
            { new JsonValue.Null(), default, default },
    ...
    public static TheoryData<JsonValue, JsonValue.Null> AsNullOrDefault_NoArgs_Data =>
        new()
        {
            { State(0), default },
    ...
    public static TheoryData<JsonValue, JsonValue.Number> AsNumberOrDefault_NoArgs_Data =>
        new()
        {
            { State(0), default },
            { new JsonValue.Null(), default },
    ...
    public static TheoryData<
        ...
        JsonValue.Number,
        JsonValue.Number
    > AsNumberOrDefault_WithArgs_Data =>
        new()
        {
            { State(0), default, default },
            { new JsonValue.Null(), default, default },
    ...
    public static TheoryData<JsonValue, JsonValue.Object> AsObjectOrDefault_NoArgs_Data =>
        new()
        {
            { State(0), default },
            { new JsonValue.Null(), default },
    ...
    public static TheoryData<
        ...
        JsonValue.Object,
        JsonValue.Object
    > AsObjectOrDefault_WithArgs_Data =>
        new()
        {
            { State(0), default, default },
            { new JsonValue.Null(), default, default },
    ...
    public static TheoryData<JsonValue, JsonValue.String> AsStringOrDefault_NoArgs_Data =>
        new()
        {
            { State(0), default },
            { new JsonValue.Null(), default },
    ...
    public static TheoryData<
        ...
        JsonValue.String,
        JsonValue.String
    > AsStringOrDefault_WithArgs_Data =>
        new()
        {
            { State(0), default, default },
            { new JsonValue.Null(), default, default },
    ...
    public static TheoryData<
        JsonValue,
        JsonValue.Array?
    > ExplicitCast_FromJsonValue_ToArrayJsonValue_Data =>
        new()
        {
    ...
    public static TheoryData<
        JsonValue,
        JsonValue.Boolean?
    > ExplicitCast_FromJsonValue_ToBooleanJsonValue_Data =>
        new()
        {
            { new JsonValue.Null(), null },
            { new JsonValue.String("abc"), null },
    ...
    public static TheoryData<
        JsonValue,
        JsonValue.Null?
    > ExplicitCast_FromJsonValue_ToNullJsonValue_Data =>
        new()
        {
            { new JsonValue.Null(), new() },
            { new JsonValue.String("abc"), null },
    ...
    public static TheoryData<
        JsonValue,
        JsonValue.Number?
    > ExplicitCast_FromJsonValue_ToNumberJsonValue_Data =>
        new()
        {
            { new JsonValue.Null(), null },
            { new JsonValue.String("abc"), null },
    ...
    public static TheoryData<
        JsonValue,
        JsonValue.Object?
    > ExplicitCast_FromJsonValue_ToObjectJsonValue_Data =>
        new()
        {
            { new JsonValue.Null(), null },
            { new JsonValue.String("abc"), null },
    ...
    public static TheoryData<
        JsonValue,
        JsonValue.String?
    > ExplicitCast_FromJsonValue_ToStringJsonValue_Data =>
        new()
        {
            { new JsonValue.Null(), null },
            { new JsonValue.String("abc"), new("abc") },
    ...
    public static TheoryData<
        JsonValue.Array,
        JsonValue
    > ImplicitCast_ToJsonValue_FromArrayJsonValue_Data =>
        new() { { new(_array), new JsonValue.Array(_array) } };

    public static TheoryData<
        JsonValue.Boolean,
        JsonValue
    > ImplicitCast_ToJsonValue_FromBooleanJsonValue_Data =>
        new()
        {
    ...
    public static TheoryData<
        JsonValue.Null,
        JsonValue
    > ImplicitCast_ToJsonValue_FromNullJsonValue_Data => new() { { new(), new JsonValue.Null() } };

    public static TheoryData<
        JsonValue.Number,
        JsonValue
    > ImplicitCast_ToJsonValue_FromNumberJsonValue_Data =>
        new() { { new(1234), new JsonValue.Number(1234) } };

    public static TheoryData<
        JsonValue.Object,
        JsonValue
    > ImplicitCast_ToJsonValue_FromObjectJsonValue_Data =>
        new() { { new(_object), new JsonValue.Object(_object) } };

    public static TheoryData<
        JsonValue.String,
        JsonValue
    > ImplicitCast_ToJsonValue_FromStringJsonValue_Data =>
        new() { { new("abc"), new JsonValue.String("abc") } };

    public static TheoryData<JsonValue, bool, JsonValue.Array> IsArray_Data =>
        new()
        {
    ...
    public static TheoryData<JsonValue, bool, JsonValue.Boolean> IsBoolean_Data =>
        new()
        {
            { State(0), false, default },
            { new JsonValue.Null(), false, default },
    ...
    public static TheoryData<JsonValue, bool, JsonValue.Null> IsNull_Data =>
        new()
        {
            { State(0), false, default },
    ...
    public static TheoryData<JsonValue, bool, JsonValue.Number> IsNumber_Data =>
        new()
        {
            { State(0), false, default },
            { new JsonValue.Null(), false, default },
    ...
    public static TheoryData<JsonValue, bool, JsonValue.Object> IsObject_Data =>
        new()
        {
            { State(0), false, default },
            { new JsonValue.Null(), false, default },
    ...
    public static TheoryData<JsonValue, bool, JsonValue.String> IsString_Data =>
        new()
        {
            { State(0), false, default },
            { new JsonValue.Null(), false, default },
    ...
    public static TheoryData<JsonValue, object?> Match_NoDefault_Data =>
        new()
        {
            { new JsonValue.Null(), null },
    ...
    public static TheoryData<JsonValue, string> Match_NoDefault_NullSelector_Data =>
        new()
        {
    ...
    public static TheoryData<JsonValue> Match_WithDefault_Default_Data =>
        new()
        {
            new JsonValue.Null(),
            new JsonValue.String("abc"),
    ...
    public static TheoryData<JsonValue, object?> Match_WithDefault_NotDefault_Data =>
        new()
        {
            { new JsonValue.Null(), null },
            { new JsonValue.String("abc"), "abc" },
    ...
    public static TheoryData<JsonValue> Match_WithDefault_NullSelector_Default_Data =>
        new()
        {
            new JsonValue.Null(),
            new JsonValue.String("abc"),
    ...
    public static TheoryData<JsonValue> Match_WithDefault_NullSelector_NullDefault_Data =>
        new()
        {
            new JsonValue.Null(),
            new JsonValue.String("abc"),
    ...
    public static TheoryData<JsonValue, object?> Switch_NoDefault_Data =>
        new()
        {
            { new JsonValue.Null(), null },
            { new JsonValue.String("abc"), "abc" },
    ...
    public static TheoryData<JsonValue, string> Switch_NoDefault_NullSelector_Data =>
        new()
        {
            { new JsonValue.Null(), "caseNull" },
            { new JsonValue.String("abc"), "caseString" },
    ...
    public static TheoryData<JsonValue> Switch_WithDefault_Default_Data =>
        new()
        {
            new JsonValue.Null(),
            new JsonValue.String("abc"),
    ...
    public static TheoryData<JsonValue, object?> Switch_WithDefault_NotDefault_Data =>
        new()
        {
            { new JsonValue.Null(), null },
            { new JsonValue.String("abc"), "abc" },
    ...
    public static TheoryData<JsonValue> Switch_WithDefault_NullSelector_Default_Data =>
        new()
        {
            new JsonValue.Null(),
            new JsonValue.String("abc"),
    ...
    public static TheoryData<JsonValue, string> Switch_WithDefault_NullSelector_NullDefault_Data =>
        new()
        {
            { new JsonValue.Null(), "caseNull" },
            { new JsonValue.String("abc"), "caseString" },
    ...
    public static void AsArrayOrDefault_FactoryArg(
        JsonValue value,
        JsonValue.Array @default,
    ...
    [Theory]
    [MemberData(nameof(AsArrayOrDefault_WithArgs_Data))]
    public static void AsArrayOrDefault_ValueArg(
        JsonValue value,
        JsonValue.Array @default,
        JsonValue.Array expected
    )
    ...
    public static void AsBooleanOrDefault_FactoryArg(
        JsonValue value,
        JsonValue.Boolean @default,
        JsonValue.Boolean expected
    )
    {
        // arrange
    ...
    [Theory]
    [MemberData(nameof(AsBooleanOrDefault_WithArgs_Data))]
    public static void AsBooleanOrDefault_ValueArg(
        JsonValue value,
        JsonValue.Boolean @default,
        JsonValue.Boolean expected
    )
    ...
    public static void AsNullOrDefault_FactoryArg(
        JsonValue value,
        JsonValue.Null @default,
    ...
    [Theory]
    [MemberData(nameof(AsNullOrDefault_WithArgs_Data))]
    public static void AsNullOrDefault_ValueArg(
        JsonValue value,
        JsonValue.Null @default,
        JsonValue.Null expected
    )
    ...
    public static void AsNumberOrDefault_FactoryArg(
        JsonValue value,
        JsonValue.Number @default,
    ...
    [Theory]
    [MemberData(nameof(AsNumberOrDefault_WithArgs_Data))]
    public static void AsNumberOrDefault_ValueArg(
        JsonValue value,
        JsonValue.Number @default,
        JsonValue.Number expected
    )
    ...
    public static void AsObjectOrDefault_FactoryArg(
        JsonValue value,
    ...
    [Theory]
    [MemberData(nameof(AsObjectOrDefault_WithArgs_Data))]
    public static void AsObjectOrDefault_ValueArg(
        JsonValue value,
        JsonValue.Object @default,
        JsonValue.Object expected
    )
    ...
    public static void AsStringOrDefault_FactoryArg(
        JsonValue value,
    ...
    [Theory]
    [MemberData(nameof(AsStringOrDefault_WithArgs_Data))]
    public static void AsStringOrDefault_ValueArg(
        JsonValue value,
        JsonValue.String @default,
        JsonValue.String expected
    )
    ...
    public static void ExplicitCast_FromJsonValue_ToArrayJsonValue(
        JsonValue value,
        JsonValue.Array? expected
    )
    {
    ...
    public static void ExplicitCast_FromJsonValue_ToBooleanJsonValue(
        JsonValue value,
        JsonValue.Boolean? expected
    )
    {
    ...
    public static void ExplicitCast_FromJsonValue_ToNullJsonValue(
        JsonValue value,
        JsonValue.Null? expected
    )
    {
    ...
    public static void ExplicitCast_FromJsonValue_ToNumberJsonValue(
        JsonValue value,
        JsonValue.Number? expected
    )
    {
    ...
    public static void ExplicitCast_FromJsonValue_ToObjectJsonValue(
        JsonValue value,
        JsonValue.Object? expected
    )
    {
    ...
    public static void ExplicitCast_FromJsonValue_ToStringJsonValue(
        JsonValue value,
        JsonValue.String? expected
    )
    {
    ...
    public static void ImplicitCast_ToJsonValue_FromArrayJsonValue(
    ...
    public static void ImplicitCast_ToJsonValue_FromBooleanJsonValue(
    ...
    public static void ImplicitCast_ToJsonValue_FromNullJsonValue(
    ...
    public static void ImplicitCast_ToJsonValue_FromNumberJsonValue(
    ...
    public static void ImplicitCast_ToJsonValue_FromObjectJsonValue(
    ...
    public static void ImplicitCast_ToJsonValue_FromStringJsonValue(
