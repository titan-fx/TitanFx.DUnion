...
public readonly partial record struct JsonValue
{
    ...
    private static readonly FieldInfo _fDiscriminator = typeof(JsonValue).GetField(
        nameof(_discriminator),
        BindingFlags.NonPublic | BindingFlags.Instance
    )!;
    private static readonly FieldInfo _fValue = typeof(JsonValue).GetField(
        nameof(_value),
        BindingFlags.NonPublic | BindingFlags.Instance
    )!;
